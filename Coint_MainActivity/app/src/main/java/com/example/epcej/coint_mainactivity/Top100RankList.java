...
public class Top100RankList extends Activity {

    ArrayList<SearchResult> resultQueries = null;
    ListView listView = null;
    Top100Adapter top100Adapter = null;
    Cursor cursor = null;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        top100Adapter = new Top100Adapter(this, resultQueries);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {             //리스트뷰 클릭 리스너로 id를 보내줌
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Top100RankList.this,resultQueries.get(position).title.toString(),Toast.LENGTH_SHORT).show();
