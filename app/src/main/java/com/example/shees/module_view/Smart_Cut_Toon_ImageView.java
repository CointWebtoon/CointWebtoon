...
/**
 * Created by shees on 2017-03-19.
 */

public class Smart_Cut_Toon_ImageView extends ImageView {
    Context mContext;
    /*
     *커스텀 이미지 뷰
    ...
    public Smart_Cut_Toon_ImageView(Context mContext) {
        super(mContext);
    ...
    public Smart_Cut_Toon_ImageView(Context mContext, AttributeSet attributeSet) {
        super(mContext, attributeSet);
        this.mContext = mContext;
    }

    public Smart_Cut_Toon_ImageView(Context mContext, AttributeSet attributeSet, int style) {
