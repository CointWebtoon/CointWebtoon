...
public  class RecyclerAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerAdapter(Context mContext, ArrayList<Episode> episodes){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        //marquee Test
        // myHolder.epTitle.setText("흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  흘러가라  ");
